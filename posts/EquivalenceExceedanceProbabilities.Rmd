...
```{r plot0, fig.width=3.5, fig.height=3.5, echo=FALSE}
par(mar=c(3,1,1,1))
mu1 <- 1
sigma1 <- 2
mu2 <- 2.5
...
```{r plot3, fig.width=3.5, fig.height=3.5, echo=FALSE}
par(mar=c(3,1,1,1))
mu1 <- mu[1]
mu2 <- mu[2]
sigma1 <- sigma2 <- sigma
...
```{r, message=FALSE, error=TRUE, cache=TRUE}
...
sims <- mutate(sims, Delta0=100*(pnorm(USL, mu[1], sigma)-pnorm(USL, mu[2], sigma)))
head(sims)
# plutôt l'ajouter au plot avec stat_function
```
...
```{r kplot1, echo=FALSE, fig.height=5, fig.width=5}
par(mar=c(1,1,1,1))
a <- 0.4
b <- 1
M <- a*b/(1-a^2)
...
```
```{r kplot2, echo=FALSE, fig.height=5, fig.width=5}
par(mar=c(1,1,1,1))
a <- 0.75
b <- 0.13
M <- a*b/(1-a^2)
...
```{r kplot_ag1, echo=FALSE, fig.height=5, fig.width=5}
par(mar=c(2,1,1,1))
a <- 2.2
b <- 1
M <- a*b/(1-a^2)
...
```
```{r kplot_ag2, echo=FALSE, fig.height=5, fig.width=5}
par(mar=c(2,1,1,1))
a <- 2.2
b <- 2
M <- a*b/(1-a^2)
