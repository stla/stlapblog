...
Il n'est pas aisé de se souvenir de la commande avec ses options. 
C'est pourquoi j'ai écrit le script shell `findpattern.sh` qui exécute un dialogue avec l'utilisateur puis la commande :
