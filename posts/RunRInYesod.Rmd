...
This is an Haskell app created with [Yesod](https://en.wikipedia.org/wiki/Yesod_(web_framework)), and R is called from Haskell with the help of the [inline-R](https://tweag.github.io/HaskellR/) package.
...
<html>
	...
	<body>
		...
		<input id="x" type="numeric" />
		<input id="y" type="numeric" />
