...
L'observable qui n'est pas spécifié dans l'exemple du qubit à la Schrödinger pourrait être par exemple
$$
M = \begin{pmatrix} 0 & 0 \\ 0 & 1 \end{pmatrix}, 
$$
dont les deux vecteurs propres, $\kzero$ et $\kone$, ont pour valeurs propres respectives $0$ et $1$. 
...
$$
E_\kpsi(A) = \langle \psi, e^{-itA}\psi \rangle \quad 
$$
