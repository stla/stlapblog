...
<!-- ****** points object 64 ****** -->
<script id="rglkantorovich1vshader64" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
...
<script id="rglkantorovich1fshader64" type="x-shader/x-fragment"> 
	#ifdef GL_ES
...
<!-- ****** quads object 65 ****** -->
<script id="rglkantorovich1vshader65" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich1fshader65" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 66 ****** -->
<script id="rglkantorovich1vshader66" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich1fshader66" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<script type="text/javascript"> 
	...
	function rglkantorovich1webGLStart() {
	   ...
	   gl.attachShader(prog64, getShader( gl, "rglkantorovich1vshader64" ));
	   gl.attachShader(prog64, getShader( gl, "rglkantorovich1fshader64" ));
	   ...
	   gl.attachShader(prog65, getShader( gl, "rglkantorovich1vshader65" ));
	   gl.attachShader(prog65, getShader( gl, "rglkantorovich1fshader65" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog66, getShader( gl, "rglkantorovich1vshader66" ));
	   gl.attachShader(prog66, getShader( gl, "rglkantorovich1fshader66" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler66 = gl.getUniformLocation(prog66,"uSampler");
    	   handleLoadedTexture(texture66, document.getElementById("rglkantorovich1textureCanvas"));
	   var v=new Float32Array([
...
<img src="rglkantorovich2snapshot.png" alt="rglkantorovich2snapshot" width=505/><br>
	Your browser does not support the HTML5 canvas element.</canvas>
<!-- ****** lines object 68 ****** -->
<script id="rglkantorovich2vshader68" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader68" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 69 ****** -->
<script id="rglkantorovich2vshader69" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader69" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 70 ****** -->
<script id="rglkantorovich2vshader70" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader70" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 71 ****** -->
<script id="rglkantorovich2vshader71" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader71" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 72 ****** -->
<script id="rglkantorovich2vshader72" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader72" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** surface object 73 ****** -->
<script id="rglkantorovich2vshader73" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader73" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 74 ****** -->
<script id="rglkantorovich2vshader74" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader74" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 75 ****** -->
<script id="rglkantorovich2vshader75" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader75" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** quads object 76 ****** -->
<script id="rglkantorovich2vshader76" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader76" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 77 ****** -->
<script id="rglkantorovich2vshader77" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader77" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 78 ****** -->
<script id="rglkantorovich2vshader78" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader78" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** lines object 79 ****** -->
<script id="rglkantorovich2vshader79" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader79" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 80 ****** -->
<script id="rglkantorovich2vshader80" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader80" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** points object 81 ****** -->
<script id="rglkantorovich2vshader81" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader81" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** linestrip object 82 ****** -->
<script id="rglkantorovich2vshader82" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader82" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 83 ****** -->
<script id="rglkantorovich2vshader83" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader83" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<!-- ****** text object 84 ****** -->
<script id="rglkantorovich2vshader84" type="x-shader/x-vertex">
	attribute vec3 aPos;
	attribute vec4 aCol;
	uniform mat4 mvMatrix;
	uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader84" type="x-shader/x-fragment"> 
	#ifdef GL_ES
	precision highp float;
	#endif
	varying vec4 vCol; // carries alpha
...
<script type="text/javascript"> 
	...
	function rglkantorovich2webGLStart() {
	   ...
	   gl.attachShader(prog68, getShader( gl, "rglkantorovich2vshader68" ));
	   gl.attachShader(prog68, getShader( gl, "rglkantorovich2fshader68" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog69, getShader( gl, "rglkantorovich2vshader69" ));
	   gl.attachShader(prog69, getShader( gl, "rglkantorovich2fshader69" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog70, getShader( gl, "rglkantorovich2vshader70" ));
	   gl.attachShader(prog70, getShader( gl, "rglkantorovich2fshader70" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler70 = gl.getUniformLocation(prog70,"uSampler");
    	   handleLoadedTexture(texture70, document.getElementById("rglkantorovich2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.attachShader(prog71, getShader( gl, "rglkantorovich2vshader71" ));
	   gl.attachShader(prog71, getShader( gl, "rglkantorovich2fshader71" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var texinfo = drawTextToCanvas(texts, 1);	 
	   var canvasX71 = texinfo.canvasX;
	   var canvasY71 = texinfo.canvasY;
	   var ofsLoc71 = gl.getAttribLocation(prog71, "aOfs");
	   var texture71 = gl.createTexture();
	   var texLoc71 = gl.getAttribLocation(prog71, "aTexcoord");
	   var sampler71 = gl.getUniformLocation(prog71,"uSampler");
    	   handleLoadedTexture(texture71, document.getElementById("rglkantorovich2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.bufferData(gl.ARRAY_BUFFER, v, gl.STATIC_DRAW);
	   var ibuf71 = gl.createBuffer();
	   gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, ibuf71);
	   gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f, gl.STATIC_DRAW);
	   ...
	   gl.attachShader(prog72, getShader( gl, "rglkantorovich2vshader72" ));
	   gl.attachShader(prog72, getShader( gl, "rglkantorovich2fshader72" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler72 = gl.getUniformLocation(prog72,"uSampler");
    	   handleLoadedTexture(texture72, document.getElementById("rglkantorovich2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.attachShader(prog73, getShader( gl, "rglkantorovich2vshader73" ));
	   gl.attachShader(prog73, getShader( gl, "rglkantorovich2fshader73" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var normLoc73 = gl.getAttribLocation(prog73, "aNorm");
	   var centers73 = new Float32Array([
	   ...
	   gl.bufferData(gl.ARRAY_BUFFER, v, gl.STATIC_DRAW);
	   var ibuf73 = gl.createBuffer();
	   gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, ibuf73);
	   gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f73, gl.DYNAMIC_DRAW);
	   var mvMatLoc73 = gl.getUniformLocation(prog73,"mvMatrix");
	   var prMatLoc73 = gl.getUniformLocation(prog73,"prMatrix");
	   var normMatLoc73 = gl.getUniformLocation(prog73,"normMatrix");
	   // ****** lines object 74 ******
	   var prog74  = gl.createProgram();
	   gl.attachShader(prog74, getShader( gl, "rglkantorovich2vshader74" ));
	   gl.attachShader(prog74, getShader( gl, "rglkantorovich2fshader74" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog75, getShader( gl, "rglkantorovich2vshader75" ));
	   gl.attachShader(prog75, getShader( gl, "rglkantorovich2fshader75" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog76, getShader( gl, "rglkantorovich2vshader76" ));
	   gl.attachShader(prog76, getShader( gl, "rglkantorovich2fshader76" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var normLoc76 = gl.getAttribLocation(prog76, "aNorm");
	   var f=new Uint16Array([
	    0, 1, 2, 0, 2, 3
	   ]);
	   ...
	   var normMatLoc76 = gl.getUniformLocation(prog76,"normMatrix");
	   // ****** points object 77 ******
	   var prog77  = gl.createProgram();
	   gl.attachShader(prog77, getShader( gl, "rglkantorovich2vshader77" ));
	   gl.attachShader(prog77, getShader( gl, "rglkantorovich2fshader77" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog78, getShader( gl, "rglkantorovich2vshader78" ));
	   gl.attachShader(prog78, getShader( gl, "rglkantorovich2fshader78" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog79, getShader( gl, "rglkantorovich2vshader79" ));
	   gl.attachShader(prog79, getShader( gl, "rglkantorovich2fshader79" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog80, getShader( gl, "rglkantorovich2vshader80" ));
	   gl.attachShader(prog80, getShader( gl, "rglkantorovich2fshader80" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog81, getShader( gl, "rglkantorovich2vshader81" ));
	   gl.attachShader(prog81, getShader( gl, "rglkantorovich2fshader81" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog82, getShader( gl, "rglkantorovich2vshader82" ));
	   gl.attachShader(prog82, getShader( gl, "rglkantorovich2fshader82" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   gl.attachShader(prog83, getShader( gl, "rglkantorovich2vshader83" ));
	   gl.attachShader(prog83, getShader( gl, "rglkantorovich2fshader83" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var sampler83 = gl.getUniformLocation(prog83,"uSampler");
    	   handleLoadedTexture(texture83, document.getElementById("rglkantorovich2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   gl.attachShader(prog84, getShader( gl, "rglkantorovich2vshader84" ));
	   gl.attachShader(prog84, getShader( gl, "rglkantorovich2fshader84" ));
	   //  Force aPos to location 0, aCol to location 1 
	   ...
	   var texinfo = drawTextToCanvas(texts, 1);	 
	   var canvasX84 = texinfo.canvasX;
	   var canvasY84 = texinfo.canvasY;
	   var ofsLoc84 = gl.getAttribLocation(prog84, "aOfs");
	   var texture84 = gl.createTexture();
	   var texLoc84 = gl.getAttribLocation(prog84, "aTexcoord");
	   var sampler84 = gl.getUniformLocation(prog84,"uSampler");
    	   handleLoadedTexture(texture84, document.getElementById("rglkantorovich2textureCanvas"));
	   var v=new Float32Array([
	   ...
	   function drawScene(){
	     ...
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
	     gl.enableVertexAttribArray( texLoc71 );
	     gl.vertexAttribPointer(texLoc71, 2, gl.FLOAT, false, 28, 12);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture71);
	     gl.uniform1i( sampler71, 0);
	     gl.enableVertexAttribArray( ofsLoc71 );
	     gl.vertexAttribPointer(ofsLoc71, 2, gl.FLOAT, false, 28, 20);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 28,  0);
	     gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 0);
	     // ****** text object 72 *******
	     ...
	     gl.uniformMatrix4fv( normMatLoc76, false, new Float32Array(normMatrix.getAsArray()) );
	     gl.enableVertexAttribArray( posLoc );
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0, 1, 0, 1 );
	     gl.enableVertexAttribArray( normLoc76 );
	     gl.vertexAttribPointer(normLoc76, 3, gl.FLOAT, false, 24, 12);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 24,  0);
	     gl.drawElements(gl.TRIANGLES, 6, gl.UNSIGNED_SHORT, 0);
	     // ****** points object 77 *******
	     ...
	     gl.vertexAttribPointer(texLoc83, 2, gl.FLOAT, false, 44, 28);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture83);
	     gl.uniform1i( sampler83, 0);
	     gl.enableVertexAttribArray( ofsLoc83 );
	     gl.vertexAttribPointer(ofsLoc83, 2, gl.FLOAT, false, 44, 36);
	     ...
	     gl.enableVertexAttribArray( colLoc );
	     gl.vertexAttribPointer(colLoc, 4, gl.FLOAT, false, 44, 12);
	     gl.enableVertexAttribArray( texLoc84 );
	     gl.vertexAttribPointer(texLoc84, 2, gl.FLOAT, false, 44, 28);
	     gl.activeTexture(gl.TEXTURE0);
	     gl.bindTexture(gl.TEXTURE_2D, texture84);
	     gl.uniform1i( sampler84, 0);
	     gl.enableVertexAttribArray( ofsLoc84 );
	     gl.vertexAttribPointer(ofsLoc84, 2, gl.FLOAT, false, 44, 36);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 44,  0);
	     gl.drawElements(gl.TRIANGLES, 30, gl.UNSIGNED_SHORT, 0);
	     ...
	     gl.uniformMatrix4fv( normMatLoc73, false, new Float32Array(normMatrix.getAsArray()) );
	     gl.enableVertexAttribArray( posLoc );
	     var depths = new Float32Array(841);
	     var faces = new Array(841);
	     for(var i=0; i<841; i++) {
	       var z = prmvMatrix.m13*centers73[3*i] 
	             + prmvMatrix.m23*centers73[3*i+1]
	             + prmvMatrix.m33*centers73[3*i+2]
	             + prmvMatrix.m43;
	       var w = prmvMatrix.m14*centers73[3*i] 
	             + prmvMatrix.m24*centers73[3*i+1]
	             + prmvMatrix.m34*centers73[3*i+2]
	             + prmvMatrix.m44;
	       depths[i] = z/w;
	       faces[i] = i;
	     }
	     ...
	     var f = new Uint16Array(f73.length);
	     for (var i=0; i<841; i++) {
	       for (var j=0; j<6; j++) {
	         f[6*i + j] = f73[6*faces[i] + j];
	       }
	     }	     
	     gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f, gl.DYNAMIC_DRAW);
	     gl.disableVertexAttribArray( colLoc );
	     gl.vertexAttrib4f( colLoc, 0.6784314, 0.8470588, 0.9019608, 0.4980392 );
	     gl.enableVertexAttribArray( normLoc73 );
	     gl.vertexAttribPointer(normLoc73, 3, gl.FLOAT, false, 24, 12);
	     gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 24,  0);
