...
<!-- ****** text object 9 ****** -->
<script id="rglkantorovich1vshader9" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="rglkantorovich1fshader9" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
gl.attachShader(prog9, getShader( gl, "rglkantorovich1vshader9" ));
gl.attachShader(prog9, getShader( gl, "rglkantorovich1fshader9" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture9, document.getElementById("rglkantorovich1textureCanvas"));
var v=new Float32Array([
...
mvMatrix.translate(-0, -0, -22.04767);
...
<!-- ****** linestrip object 27 ****** -->
<script id="rglkantorovich2vshader27" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader27" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 28 ****** -->
<script id="rglkantorovich2vshader28" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader28" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
<!-- ****** text object 29 ****** -->
<script id="rglkantorovich2vshader29" type="x-shader/x-vertex">
attribute vec3 aPos;
attribute vec4 aCol;
uniform mat4 mvMatrix;
uniform mat4 prMatrix;
...
<script id="rglkantorovich2fshader29" type="x-shader/x-fragment"> 
#ifdef GL_ES
precision highp float;
#endif
varying vec4 vCol; // carries alpha
...
var clipLoc13p1 = gl.getUniformLocation(prog13, "vClipplane1");
var clipLoc13p2 = gl.getUniformLocation(prog13, "vClipplane2");
...
handleLoadedTexture(texture15, document.getElementById("rglkantorovich2textureCanvas"));
var v=new Float32Array([
...
handleLoadedTexture(texture16, document.getElementById("rglkantorovich2textureCanvas"));
var v=new Float32Array([
...
handleLoadedTexture(texture17, document.getElementById("rglkantorovich2textureCanvas"));
var v=new Float32Array([
...
var centers18 = new Float32Array([
...
gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, f18, gl.DYNAMIC_DRAW);
...
gl.attachShader(prog27, getShader( gl, "rglkantorovich2vshader27" ));
gl.attachShader(prog27, getShader( gl, "rglkantorovich2fshader27" ));
//  Force aPos to location 0, aCol to location 1 
...
gl.attachShader(prog28, getShader( gl, "rglkantorovich2vshader28" ));
gl.attachShader(prog28, getShader( gl, "rglkantorovich2fshader28" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture28, document.getElementById("rglkantorovich2textureCanvas"));
var v=new Float32Array([
...
gl.attachShader(prog29, getShader( gl, "rglkantorovich2vshader29" ));
gl.attachShader(prog29, getShader( gl, "rglkantorovich2fshader29" ));
//  Force aPos to location 0, aCol to location 1 
...
handleLoadedTexture(texture29, document.getElementById("rglkantorovich2textureCanvas"));
var v=new Float32Array([
...
var textScaleLoc29 = gl.getUniformLocation(prog29,"textScale");
gl.enable(gl.DEPTH_TEST);
gl.depthFunc(gl.LEQUAL);
gl.clearDepth(1.0);
gl.clearColor(1,1,1,1);
...
mvMatrix.multRight( userMatrix[1] );
mvMatrix.translate(-0, -0, -243.0508);
normMatrix.makeIdentity();
...
gl.uniform2f( textScaleLoc16, 0.001488095, 0.001488095);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
...
gl.vertexAttribPointer(texLoc28, 2, gl.FLOAT, false, 44, 28);
gl.activeTexture(gl.TEXTURE0);
gl.bindTexture(gl.TEXTURE_2D, texture28);
gl.uniform1i( sampler28, 0);
gl.enableVertexAttribArray( ofsLoc28 );
gl.vertexAttribPointer(ofsLoc28, 2, gl.FLOAT, false, 44, 36);
...
gl.uniform2f( textScaleLoc29, 0.001488095, 0.001488095);
gl.enableVertexAttribArray( posLoc );
gl.enableVertexAttribArray( colLoc );
gl.vertexAttribPointer(colLoc, 4, gl.FLOAT, false, 44, 12);
gl.enableVertexAttribArray( texLoc29 );
gl.vertexAttribPointer(texLoc29, 2, gl.FLOAT, false, 44, 28);
gl.activeTexture(gl.TEXTURE0);
gl.bindTexture(gl.TEXTURE_2D, texture29);
gl.uniform1i( sampler29, 0);
gl.enableVertexAttribArray( ofsLoc29 );
gl.vertexAttribPointer(ofsLoc29, 2, gl.FLOAT, false, 44, 36);
gl.vertexAttribPointer(posLoc,  3, gl.FLOAT, false, 44,  0);
gl.drawElements(gl.TRIANGLES, 30, gl.UNSIGNED_SHORT, 0);
...
for(var i=0; i<841; i++) {
var z = prmvMatrix.m13*centers18[3*i] 
+ prmvMatrix.m23*centers18[3*i+1]
+ prmvMatrix.m33*centers18[3*i+2]
+ prmvMatrix.m43;
var w = prmvMatrix.m14*centers18[3*i] 
+ prmvMatrix.m24*centers18[3*i+1]
+ prmvMatrix.m34*centers18[3*i+2]
+ prmvMatrix.m44;
depths[i] = z/w;
faces[i] = i;
}
...
var f = new Uint16Array(f18.length);
for (var i=0; i<841; i++) {
for (var j=0; j<6; j++) {
f[6*i + j] = f18[6*faces[i] + j];
}
}	     
...
invMatrix.invert();
// ****** clipplanes object 12 *******
var IMVClip12p1 = multMV(invMatrix, vClipplane12.slice(0, 4));
var IMVClip12p2 = multMV(invMatrix, vClipplane12.slice(4, 8));
// ****** lines object 13 *******
gl.useProgram(prog13);
gl.bindBuffer(gl.ARRAY_BUFFER, buf13);
gl.uniformMatrix4fv( prMatLoc13, false, new Float32Array(prMatrix.getAsArray()) );
gl.uniformMatrix4fv( mvMatLoc13, false, new Float32Array(mvMatrix.getAsArray()) );
gl.uniform4fv(clipLoc13p1, IMVClip12p1);
gl.uniform4fv(clipLoc13p2, IMVClip12p2);
gl.enableVertexAttribArray( posLoc );
gl.disableVertexAttribArray( colLoc );
gl.vertexAttrib4f( colLoc, 0, 0, 0, 1 );
gl.lineWidth( 1 );
...
var whichSubscene = function(coords){
if (0 <= coords.x && coords.x <= 504 && 0 <= coords.y && coords.y <= 504) return(11);
if (0 <= coords.x && coords.x <= 504 && 0 <= coords.y && coords.y <= 504) return(1);
return(1);
}
var translateCoords = function(subsceneid, coords){
...
## [[1]]
##           [,1] [,2]      [,3]
## [1,] 0.1428571 0.00 0.0000000
## [2,] 0.0000000 0.00 0.2857143
## [3,] 0.1071429 0.25 0.2142857
## 
## [[2]]
##           [,1] [,2]      [,3]
## [1,] 0.1428571 0.00 0.0000000
## [2,] 0.1071429 0.00 0.1785714
## [3,] 0.0000000 0.25 0.3214286
## 
## [[3]]
##           [,1]       [,2] [,3]
## [1,] 0.1428571 0.00000000  0.0
## [2,] 0.1071429 0.17857143  0.0
## [3,] 0.0000000 0.07142857  0.5
## 
## [[4]]
##           [,1] [,2]       [,3]
## [1,] 0.1428571 0.00 0.00000000
## [2,] 0.0000000 0.25 0.03571429
## [3,] 0.1071429 0.00 0.46428571
## 
## [[5]]
##            [,1] [,2] [,3]
## [1,] 0.14285714 0.00  0.0
## [2,] 0.03571429 0.25  0.0
## [3,] 0.07142857 0.00  0.5
```
...
```
## Error in kable_markdown(x = structure(c("0", "1", "1", "1", "0", "1", : the table must have a header (column names)
```
...
```
##  [1] 0.6428571 0.5357143 0.1785714 0.1428571 0.1071429 0.7857143 0.5357143
##  [8] 0.4642857 0.5714286 0.3928571 0.3928571 0.4285714 0.9285714 0.6071429
## [15] 0.6785714
```
