...
```{r setup0, echo=FALSE}
opts_chunk$set(fig.path="assets/fig/sampleSizeGaussianMean")
```
...
This article explains the methodology implemented in the Shiny application available at https://stla.shinyapps.io/samplesize_mean.
